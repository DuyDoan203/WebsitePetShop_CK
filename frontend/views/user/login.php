...
$error = '';
$username = '';
// Nếu người dùng yêu cầu đăng nhập để truy cập một trang bảo vệ, lưu lại URL hiện tại
$redirect_url = isset($_GET['redirect_to']) ? $_GET['redirect_to'] : '../home.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($user && password_verify($password, $user['password'])) {
		...
		header("Location: " . $redirect_url);  // Chuyển hướng về trang yêu cầu hoặc trang mặc định
		exit();  // Dừng lại để tránh tiếp tục chạy mã sau khi đã chuyển hướng
	} else {
